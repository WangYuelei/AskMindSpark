...
public class ChatBotClient {
    ...
    private static final String API_BASE_URL = "http://deepseek-api-test.in.ixinzang.com";
    ...
    // 问题间等待时间(毫秒)
    private static final long QUESTION_DELAY = 15000; // 15秒
    ...
    private static void loadConfig() throws IOException {
        ...
        // 从配置中获取参数
        QUESTION_FILE_PATH = configMap.get("QUESTION_FILE_PATH");
        AUTH_TOKEN = configMap.get("AUTH_TOKEN");
